    ...
    <tr>
      <td align="center" style="padding:0 16px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:600px;">
          ...
          <tr>
            <td align="center" style="padding:12px 4px 2px 4px; font-size:12px; line-height:1.3;">
              <a href="${STATIC_LINKS.premRawat}" style="${linkStyle}">Prem Rawat</a>${sep}<a href="${STATIC_LINKS.i4joy}" style="${linkStyle}">i4Joy</a>${sep}<a href="${STATIC_LINKS.youtube}" style="${linkStyle}">Youtube</a>${sep}<a href="${STATIC_LINKS.timelessToday}" style="${linkStyle}">TimelessToday</a>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding:2px 4px 18px 4px; font-size:12px; line-height:1.3;">
              <a href="${STATIC_LINKS.tprf}" style="${linkStyle}">TPRF</a>${sep}<a href="${STATIC_LINKS.intelligentExistence}" style="${linkStyle}">Intelligent Existence</a>${sep}<a href="${STATIC_LINKS.breathBook}" style="${linkStyle}">Breath Book</a>${sep}<a href="${STATIC_LINKS.growWithKnowledge}" style="${linkStyle}">Grow with Knowledge</a>
            </td>
          </tr>
        </table>
        <!--[if mso]>
